...
RUN mv ugsphp/conf/config.php_example ugsphp/conf/config.php
RUN mv ugsphp/conf/settings.js_example ugsphp/conf/settings.js

EXPOSE 80 443

VOLUME /var/www/app/cpm
VOLUME /var/www/app/ugsphp/conf
